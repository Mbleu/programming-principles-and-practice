/*Program that asks for names and ages, then prints the list of name-value pairs before and after sorting.*/
...
int main()
try {
	cout << "Please enter a list of names. Press 'enter' between each one." << endl
		 << "To stop entering names, type ';' on its own." << endl;
	vector<string> names;
	vector<int> ages;

	while (1) try {																										// read in names
		cout << "> ";
		string s_input;
